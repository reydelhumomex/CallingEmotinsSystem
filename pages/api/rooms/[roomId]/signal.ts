...
import { getMessagesSince, postMessage, getRoom } from '../../../../lib/signalingStore';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (req.method === 'GET') {
    ...
    const { messages, lastId } = getMessagesSince(roomId, sinceId, excludeFrom);
  ...
  if (req.method === 'POST') {
    ...
    const msg = postMessage(roomId, String(from), String(type) as any, payload);
